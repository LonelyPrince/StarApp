...
////            <#statements#>
////        }
//        NSLog(@"self.bounds333 %f",CGRectGetWidth(self.bounds));
//        NSLog(@"self.bounds3334 %f",CGRectGetHeight(self.bounds));
...
//        NSLog(@"self.boundsyyy1 %f",CGRectGetMinY(self.bounds));
//    }else
//    {
//        if (CGRectGetWidth(self.bounds) > 400) {
//            NSLog(@"self.bounds 错了");
//            
//            self.topBar.frame = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetMinY(self.bounds),  CGRectGetWidth(self.bounds), 85);//71  //43);
//            self.bottomBar.frame = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetHeight(self.bounds) - 75, CGRectGetWidth(self.bounds), 100);
//            
//            NSLog(@"self.boundsyyy2 %f",CGRectGetMinY(self.bounds));
//        }else
//        {
...
//            NSLog(@"self.boundsyyy3 %f",CGRectGetMinY(self.bounds));
//
//        }
//        
//         NSLog(@"self.bounds %f",CGRectGetHeight(self.bounds));
////        NSLog(@"self.bounds %f",CGRectGetHeight(self.bounds));
////        NSLog(@"self.bounds1 %f",CGRectGetWidth(self.bounds));
////        NSLog(@"self.bounds2 %f",CGRectGetMinX(self.bounds));
////        NSLog(@"self.bounds2 %f",CGRectGetMaxX(self.bounds));
//        
//    }
//    
