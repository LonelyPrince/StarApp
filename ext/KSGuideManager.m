...
- (void)myInit {
    ...
    button.hidden = YES;
    [button setFrame:CGRectMake(0, 0, 120, 44)];
    [button setImage:[UIImage imageNamed:@"GroupEnter"] forState:UIControlStateNormal];
...
//        _pageControl.backgroundColor = [UIColor redColor];
        ...
        _pageControl.currentPageIndicatorTintColor =RGBA(0x9a, 0xb6, 0xfe, 1);
...
- (void)nextButtonHandler:(id)sender {
    ...
    //创建通知
    NSNotification *notification =[NSNotification notificationWithName:@"enterTVView" object:nil userInfo:nil];
    //通过通知中心发送通知
...
-(void)pageTurn:(UIPageControl *)sender
{
    ...
    [self.view setContentOffset:CGPointMake((pageNum)*viewSize.width, 0)];
    NSLog(@"myscrollView.contentOffSet.x==%f",self.view.contentOffset.x);
